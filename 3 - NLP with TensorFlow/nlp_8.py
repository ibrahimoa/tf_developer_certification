...
model.add(Bidirectional(LSTM(150, return_sequences=True)))  # Carry content around with them. Return because we use another LSTM.
...
"""Result: This story of the heart of the heart of the heart of"""
